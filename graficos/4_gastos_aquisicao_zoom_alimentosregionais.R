...
ggsave(paste(graphdir,"gasto_aquisicao_zoomregionais_br_10marco2025.png", sep = ""), 
       plot = p1, 
...
# Salvar o gráfico como .png
ggsave(paste(graphdir,"gasto_aquisicao_zoomregionais_mediaestados_10marco2025.png", sep = ""), 
       plot = p2, 
       width = 10,  # Largura em polegadas
       height = 7,  # Altura em polegadas
       dpi = 300,   # Resolução (dots per inch)
...
# Salvar o gráfico como .png
ggsave(paste(graphdir,"gasto_aquisicao_zoomregionais_mediacapitais_10marco2025.png", sep = ""), 
       plot = p3, 
       width = 10,  # Largura em polegadas
       height = 7,  # Altura em polegadas
       dpi = 300,   # Resolução (dots per inch)
