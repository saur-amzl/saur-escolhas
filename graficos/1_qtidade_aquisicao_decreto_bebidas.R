...
ggsave(paste(graphdir,"qtidade_aquisicao_alimdecreto_br_10marco2025v3.png", sep = ""), 
       plot = p1, 
...
# Salvar o gráfico como .png
ggsave(paste(graphdir,"qtidade_aquisicao_alimdecreto_br_semoutros_10marco2025.png", sep = ""), 
       plot = p2, 
       width = 10,  # Largura em polegadas
       height = 7,  # Altura em polegadas
       dpi = 300,   # Resolução (dots per inch)
...
# Salvar o gráfico como .png
ggsave(paste(graphdir,"qtidade_aquisicao_alimdecreto_mediaestados_10marco2025.png", sep = ""), 
       plot = p3, 
       width = 10,  # Largura em polegadas
       height = 7,  # Altura em polegadas
       dpi = 300,   # Resolução (dots per inch)
...
# Salvar o gráfico como .png
ggsave(paste(graphdir,"qtidade_aquisicao_alimdecreto_mediaestados_semoutros_10marco2025.png", sep = ""), 
       plot = p4, 
       width = 10,  # Largura em polegadas
       height = 7,  # Altura em polegadas
       dpi = 300,   # Resolução (dots per inch)
...
# Salvar o gráfico como .png
ggsave(paste(graphdir,"qtidade_aquisicao_alimdecreto_mediacapitais_10marco2025.png", sep = ""), 
       plot = p5, 
       width = 10,  # Largura em polegadas
       height = 7,  # Altura em polegadas
       dpi = 300,   # Resolução (dots per inch)
...
# Salvar o gráfico como .png
ggsave(paste(graphdir,"qtidade_aquisicao_alimdecreto_mediacapitais_semoutros_10marco2025.png", sep = ""), 
       plot = p6, 
       width = 10,  # Largura em polegadas
       height = 7,  # Altura em polegadas
       dpi = 300,   # Resolução (dots per inch)
