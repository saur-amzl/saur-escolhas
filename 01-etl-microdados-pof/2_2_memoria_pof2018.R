...
# Salva o dado 
write.table(junta_ali, paste(intdir,"tabela_base_alimentacao_pof1718_10marco2025.csv", sep = ""),
            row.names = F, sep = ";")

write.table(morador_uc, paste(intdir,"tabela_base_uc_pof1718_10marco2025.csv", sep = ""),
            row.names = F, sep = ";")

write.table(morador_pessoas, paste(intdir,"tabela_base_pessoas_pof1718_10marco2025.csv", sep = ""),
            row.names = F, sep = ";")
