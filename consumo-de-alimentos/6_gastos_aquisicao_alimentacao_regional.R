...
write.table(tab_combinada, paste0(outdir,"/tabela_aquisicao_gastos_2008_2018_regional_1marco2025.csv", sep = ""),row.names = F, sep = ";")
...
saveWorkbook(wb, file = paste0(outdir,"/tab_aquisicao_gastos_niveis_1marco2025.xlsx"), overwrite = TRUE)
